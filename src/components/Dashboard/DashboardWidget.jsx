...
const DashboardWidget = () => {
    ...
    return (
        <div className="w-full bg-gradient-to-r from-[#4f46e5] via-[#6366f1] to-[#3b82f6] rounded-xl p-3.5 text-white shadow-md shadow-indigo-500/10 relative overflow-hidden">
            ...
            <div className="absolute top-0 right-0 w-28 h-28 bg-white opacity-[0.04] rounded-full -translate-y-1/2 translate-x-1/4 pointer-events-none"></div>
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-2.5 relative z-10 gap-2">
                ...
                {/* RIGHT: Weather Data */}
                <div className="flex items-center gap-2 bg-white/10 px-3 py-1.5 rounded-lg backdrop-blur-sm border border-white/10 flex-shrink-0">
                    {loading ? (
            ...
            <div className="relative z-10 border-t border-white/10 pt-2.5">
                <div className="flex items-center justify-between mb-1">
                    <h3 className="text-[9px] font-semibold uppercase tracking-wider text-blue-200/70 flex items-center gap-1.5">
